...
<section class="mb-4  shadow-lg" style="margin: 40px;background-color: rgba(128, 128, 128, 0.073);border-radius: 50% 20% / 10% 40%;">
    ...
    <!--Section heading--><br><br><br>
    <h2 class="h1-responsive font-weight-bold text-center my-4">Notification of arrival time</h2>
    <!--Section description-->
    <p class="text-center w-responsive mx-auto mb-5">The time at which you will pick up passengers</p>
    ...
    <div class="row" style="margin: 20px;">
        ...
        <div class="col-md-8 ">
            ...
            <?php   if(isset($_SESSION['state']))
                {
                    echo '<div class="offcanvas offcanvas-start show text-bg-secondary" tabindex="-1" id="offcanvasDark" aria-labelledby="offcanvasDarkLabel">';
                    ...
                    echo "<p  class='btn btn-success btn-lg'>".$_SESSION['state']."</p>";
                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <div class="md-form mb-0"><label >ID Passenger</label>
                            <input type="text" name="PassengerID" minlength="0" maxlength="8"class="form-control" required>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="md-form mb-0"> <label for="subject" class="">Trip ID</label>
                            <input type="text"  minlength="0" maxlength="15"  name="TripID" class="form-control" required>
                           
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="md-form mb-0"> <label for="subject" class="">Booking ID</label>
                            <input type="text"  minlength="0" maxlength="12" name="BookingID"  class="form-control" required>
                ...
                <button class="btn btn-dark btn-lg btn-block" type="submit"  name="send">Send</button>
            </div>
        ...
        <div class="col-md-4 text-center">
           <img src="images/o.png" style="height: 200px;width: 265;">
        </div>
        <!--Grid column-->
