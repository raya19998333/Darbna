        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="md-form mb-0"><label for="name" class="">Email</label>
                    <input type="Email"  minlength="0" maxlength="40" id="name" name="Email" class="form-control" >
                ...
                <div class="col-md-7">
                    ...
                    <div class="col-md-5">
                      <div class="md-form mb-0"><label for="text" class="">Password</label>
                         <input class="form-control" type="password"  minlength="0" maxlength="8" name="Password">
