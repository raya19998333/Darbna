...
<body>
  ...
  <section class="layout_padding" style="color: black;">
    <div class="container  ">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="detail-box">
            <div style="background-color: rgba(255, 255, 255, 0.747); margin: 30px;padding: 40px;text-align: center;">
            <h3 class="display-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="96" height="90" fill="currentColor" class="bi bi-building-gear" viewBox="0 0 16 16">
            ...
            <h6 class="display-6">Transport companies</h6>
            <p>
                Transport companies must obtain permission from the Ministry of Transport, Communications and Information Technology before accessing the system
            </p> </div>
            
            <!--another div -->
            <div style="background-color: rgba(255, 255, 255, 0.747); margin: 30px;padding: 40px;text-align: center;">
                <h3 class="display-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="96" height="90" fill="currentColor" class="bi bi-person-video" viewBox="0 0 16 16">
                ...
                <h1 class="display-6">Private owner</h1>
                <p>
                    
                    Before you participate with us in the system, you must obtain a license from the office of the Ministry of Transport, Communications and Information Technology</p> </div>
          </div>
        </div>
      </div>
    </div>
