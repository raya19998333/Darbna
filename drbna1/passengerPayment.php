...
<div class="row">
    ...
    <div class="col-md-4">
      ...
      <input type="text" name="PassengerID" class="form-control" minlength="0" maxlength="8"  placeholder="" required>
      
    </div>
    <div class="col-md-4">
      <label for="cc-expiration">Booking Id:</label>
      <input type="text" name="booking_id" class="form-control" minlength="0"  maxlength="8" placeholder="" required>
