...
<form class="d-flex" role="search">
    ...
    <h1 class="display-1" style="text-align: center;">List Of Companyies Transport</h1>
    ...
    <table class="table table-striped">
        ...
        $i=0;
          ...
          echo "<td>{$row ['Email']}</td>";$i=$i+1;

          echo "<td><a class='btn btn-dark' href='adminUpdateCompany.php?CompanyID={$row['CompanyID']}'>Update</a></td>";
