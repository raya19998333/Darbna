...
<form class="d-flex" role="search">
    ...
    <?php
     ...
     <!--close--> 
    <!--Table 1--><br><br><br>
    <h1 class="display-3" style="text-align: center;">Payments of Reports</h1>
    ...
    <?php
           ...
           if(!$result=$conn->query($sql)){
            ...
            echo "<th>Name_on_card</th>";
            echo "<th>Credit_card_number</th>";
...
$count=0;
           ...
           echo "<td>{$row ['Date']}</td>";
           $count=$count+1;
           echo "<td><a class='btn btn-dark' href='adminUpdatePayment.php?payment_id={$row['payment_id']}&PassengerID={$row ['PassengerID']}&booking_id={$row ['booking_id']}'>Update</a></td>";
           echo '<form action="adminDeletePayment.php" method="POST">';
