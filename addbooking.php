...
if(isset($_POST['Book'])){
    ...
    if(mysqli_num_rows($check_result) > 0){
        ...
        if($result){
            ...
            $_SESSION["state"]="The ticket has been booked successfully. You will showing this page to input details about payment and arrangements for your trip.<br> Your booking ID is :".$last_id;
            header("Location: passengerPayment.php?bookingID=$last_id&PassengerID=$passenger_id");
        }
    } else {
