...
<form class="d-flex" role="search">
    ...
    <h1 class="display-1" style="text-align: center;">List of Special  Trips</h1>
    ...
    <?php
           ...
           if(!$result=$conn->query($sql)){
            ...
            echo "<thead><tr>";
            echo "<th>Trip Id</th>";
            echo "<th>Passenger Number</th>";
            echo "<th>Location</th>";
            echo "<th>Vehicle Type</th>";
            echo "<th>Transportation Place</th>";
            echo "<th>Time</th>";
            echo "<th>Date</th>";
            echo " <th>Day</th>";
            echo " <th>Price</th>";
         ...
         $i=0;
           ...
           echo "<td>{$row ['passenger_number']}</td>";
           echo "<td>{$row ['location']}</td>";
           echo "<td>{$row ['vehicle_type']}</td>";
           echo "<td>{$row ['transportation_place']}</td>";
          ...
          $i=$i+1;
          echo "<td><a class='btn btn-dark' href='adminUpdateSpecialTrip.php?trip_id={$row['trip_id']}'>Update</a></td>";
          echo '<form action="adminDeleteSpeacialTrip.php" method="POST">';
          ...
          echo "</form>";}
           ...
           echo "  </tbody>";
           echo "</table> ";
           echo "<h6 class='display-6' > The number of Speacial Trip :$i</h6>";
