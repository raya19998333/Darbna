 ...
 <div class="container-fluid all  p-3 mb-5 bg-body-tertiary rounded">
  ...
  <section class="text-center text-lg-start">
    ...
    if (isset($_REQUEST['Send'])){
      ...
      $sql="SELECT Email FROM companytransport_info WHERE Email='$email'";
  ...
  if($res>0)
  {
    $message = '<div>
     ...
     <br>
     <p><button class="btn btn-dark"><a href="http://localhost/drbna1/Resert-PasswordCompany.php?secret='.base64_encode($email).'">Reset Password</a></button></p>
     <br>
    ...
    <div class="container py-4 ">
      <div class="row g-0 align-items-center">
        <div class="col-lg-12 mb-5 mb-lg-0" class="">
          <div class="card shadow-lg p-3 mb-5 bg-body-tertiary rounded cascading-right" style="
