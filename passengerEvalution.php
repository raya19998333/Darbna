...
<br><br><br><br><br><br>
<section class="" style="background-color: #eeeeee44;">
 ...
 <?php   if(isset($_SESSION['state']))
               {
                   ...
                   echo '<h2 class="offcanvas-title" id="offcanvasDarkLabel">Feedback</h2>';
...
?></div></div>
              <div class="row justify-content-center">
                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                  ...
                  <form class="mx-1 mx-md-4" method="post" action="addfeedback.php">
