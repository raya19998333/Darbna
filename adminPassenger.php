...
<form class="d-flex" role="search">
    ...
    <h1 class="display-1" style="text-align: center;">List Of Passenger</h1>
    ...
    <div class="row"><div class="col-md-12">
            ...
            echo "<td>{$row ['Age']}</td>";
            echo "<td>{$row ['CivilNo']}</td>";
            echo "<td>{$row ['Nationality']}</td>";
            echo "<td>{$row ['Birthday']}</td>";
            echo "<td>{$row ['job']}</td>";
            echo "<td>{$row ['password_hash']}</td>";$i=$i+1;
            echo "<td><a class='btn btn-dark' href='adminUpdatePassenger.php?PassengerID={$row['PassengerID']}&Email={$row ['Email']}&password_hash={$row ['password_hash']}'>Update</a></td>";
            

echo '<form action="adminDeletePassenger.php" method="POST">';
            echo "<input type='hidden' name='PassengerID' value={$row ['PassengerID']}>";
