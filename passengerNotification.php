...
<body>
  ...
  <header>
    ...
    <nav class="navbar fixed-top navbar-expand-lg bg-body-tertiary">
     ...
     <!--close--> 
    <!--Table 1--><br><br><Br>
    <h1 class="display-5" style="text-align: center;">Notifications of special trips to passengers</h1>
  <br><br><br>
<?php
...
<?php
    ...
    while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
        ...
        echo "<h5 class='card-title'>Notification ID :{$row['notificationID']}</h5>";
        echo "<h5 class='card-title'>Number Vehicle :{$row['NumberVehicle']}</h5>";
        echo "<h5 class='card-title'>Place:{$row['Place']}</h5>";
        echo "<h5 class='card-title'>Trip ID:{$row['TripID']}</h5>";
        echo "<h5 class='card-title'>Booking ID:{$row['BookingID']}</h5>";
        echo "<h5 class='card-title'>Phone :{$row['Phone']} </h5>";
