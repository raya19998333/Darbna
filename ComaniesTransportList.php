...
<form class="d-flex" role="search">
    ...
    <h1 class="display-1" style="text-align: center;">List Of Companies Transport</h1>
    ...
    <table class="table table-striped">
        <thead><tr>
          ...
          $sql="SELECT * FROM companytransport_info ";
        ...
        $i=0;
          ...
          echo "<td>{$row ['Fax']}</td>";
          echo "<td>{$row ['Transport_Number']}</td>";
          echo "<td>{$row ['Email']}</td>";
          echo "<td>{$row ['Password']}</td>";$i=$i+1;

          echo "<td><a class='btn btn-dark' href='adminUpdateCompany.php?CompanyID={$row['CompanyID']}&Email={$row ['Email']}&Password={$row ['Password']}'>Update</a></td>";
            

          echo '<form action="adminDeleteComany.php" method="POST">';
        ...
        echo "</form>";
          ...
          echo "  </tbody>";
           echo "</table> ";
           echo "<h6 class='display-6' > The number of Companies :$i</h6>";
           ?>  
