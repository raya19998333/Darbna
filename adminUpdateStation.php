...
<div class="col-md-4">
    <div class="md-form mb-0"><label for="text" class="">Trip ID</label>
        <input type="text" name="TripID" value="<?php echo htmlspecialchars($_GET['TripID'] ?? '', ENT_QUOTES); ?>" minlength="2" maxlength="8" class="form-control" required>
...
<div class="col-md-6">
  <div class="md-form mb-0"><label for="text" class="">ID passenger</label>
      <input type="text" name="PassengerID"  value="<?php echo htmlspecialchars($_GET['PassengerID'] ?? '', ENT_QUOTES); ?>" class="form-control" minlength="2" maxlength="8" required>
