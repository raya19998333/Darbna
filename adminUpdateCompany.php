        ...
        <div class="card text-black" style="border-radius: 25px;">
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
                ...
                <form class="mx-1 mx-md-4" method="POST" action="aaaUpdateCompany.php"> 
                <div class="d-flex flex-row align-items-center mb-4">
                    <div class="form-outline flex-fill mb-0"><label for="text" class="">Company ID</label>
                     <input type="text" class="form-control" value="<?php echo htmlspecialchars($_GET['CompanyID'] ?? '', ENT_QUOTES); ?>" name="CompanyID" placeholder="">
...
<div class="col-md-6">
 ...
 <div class="col-md-6">
        <div class="md-form mb-0"><label for="name" class="">Phone</label>
            <input type="number"  name="Phone" class="form-control" minlength="0" maxlength="8" required>
...
<div class="col-md-4">
  ...
  <div class="md-form mb-0"><label for="text" class="">Email</label>
      <input type="Email"  class="form-control" value="<?php echo htmlspecialchars($_GET['Email'] ?? '', ENT_QUOTES); ?>" name="Email" minlength="0" maxlength="30" required>
...
<div class="col-md-6">
                <div class="md-form mb-0"><label for="name" class="">Password</label>
                    <input type="Password"  name="Password" value="<?php echo htmlspecialchars($_GET['Password'] ?? '', ENT_QUOTES); ?>"  class="form-control" minlength="0" maxlength="8" required>
