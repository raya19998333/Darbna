...
?></div></div>
  ...
  <div class="col-md-4">
    ...
    <input type="text" value="<?php echo htmlspecialchars($_GET['trip_id'] ?? '', ENT_QUOTES); ?>"  name="Trip_id" class="form-control" required>
  </div>
  <div class="col-12">
  ...
  <div class="col-md-4">
    ...
    <input type="date" class="form-control"  value="<?php echo htmlspecialchars($_GET['date'] ?? '', ENT_QUOTES); ?>" name="date" required>
  </div>
  <div class="col-md-4">
