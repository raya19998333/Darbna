...
<form class="d-flex" role="search">
    ...
    <?php
     ...
     <!--close--> 
    <!--Table 1--><br><br><br>
    <h1 class="display-3" style="text-align: center;">  Reports of Feedbacks</h1>
    ...
    <table class="table table-striped">
      ...
      if(!$result=$conn->query($sql)){
       ...
       echo " <th>Typy Transport</th>";
       echo " <th>Feedback Text</th>";
    ...
    $i=0;
      ...
      echo "<td>{$row ['feedback_text']}</td>";$i=$i+1;
      echo "<td><a class='btn btn-dark' href='adminUpdateFeedback.php?feedback_id={$row['feedback_id']}&passenger_id={$row ['passenger_id']}'>Update</a></td>";
            

      echo '<form action="adminDeleteFeedback.php" method="POST">';
    ...
    echo "</form>";}
      ...
      echo "  </tbody>";
      echo "</table> ";
      echo "<h6 class='display-6' > The number of Feedback :$i</h6>"; 
        ?>  
