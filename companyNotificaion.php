...
<!--Section: Contact v.2-->
<section class="mb-4 shadow-lg" style="margin: 40px;background-color: rgba(128, 128, 128, 0.073);border-radius: 50px;">
<br><br>
    <!--Section heading-->
    <h2 class="h1-responsive font-weight-bold text-center my-4">Station</h2>
    <!--Section description-->
    <p class="text-center w-responsive mx-auto mb-5">What the Stations of Your Trips?</p>

    <div class="row" style="margin: 30px;">

        <!--Grid column-->
        <div class="col-md-9 mb-md-0 mb-5">
            <form id="contact-form" name="contact-form" action="addStation.php" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="md-form mb-0"><label for="text" class="">Trip ID</label>
                            <input type="text" name="TripID" minlength="2"  value="<?php echo htmlspecialchars($_GET['trip_id'] ?? '', ENT_QUOTES); ?>" maxlength="8" class="form-control" required>
                    ...
                    <div class="col-md-6">
                      <div class="md-form mb-0"><label for="text" class="">ID passenger</label>
                          <input type="text" name="PassengerID" value="<?php echo htmlspecialchars($_GET['id'] ?? '', ENT_QUOTES); ?>" class="form-control" minlength="2" maxlength="8" required>
...
<button class="btn btn-dark btn-lg " name="send">Send</button></div>
<?php   if(isset($_SESSION['state']))
                {
                    ...
                    echo '<h2 class="offcanvas-title" id="offcanvasDarkLabel">Station</h2>';
