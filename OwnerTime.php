...
<!--Section: Contact v.2-->
<section class="mb-4 shadow-lg " style="margin: 40px;background-color: rgba(128, 128, 128, 0.073);border-radius: 100px;">

    <!--Section heading--><br><br>
    <h2 class="h1-responsive font-weight-bold text-center my-4">Special Trip</h2>
    <!--Section description-->
    <p class="text-center w-responsive mx-auto mb-5">Do you have any New Special Trip?</p>
    ...
    <div class="row" style="margin: 20px;">
        ...
        <div class="col-md-8 mb-md-0 mb-5">
            ...
            <form  action="addSpecialTrip.php" method="POST">

                <!--Grid row-->
                <div class="row">
                  <div class="col-md-12">   <?php   if(isset($_SESSION['state']))
                {
          ...
          <div class="row">
              ...
              <div class="col-md-12">
                ...
                <input class="btn btn-dark input-lg" type="submit" value="Send" name="Send">
            </div></div></div>
        ...
        <div class="col-md-4 text-center">
           <img src="images/Navigation-cuate.png" style="height: 300px;width: 365;">
        </div>
        <!--Grid column-->
