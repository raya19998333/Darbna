 ...
 <div class="container-fluid all  p-3 mb-5 bg-body-tertiary rounded">
  ...
  <section class="text-center text-lg-start">
    ...
    if (isset($_REQUEST['Send'])){
      ...
      $sql="SELECT Email FROM owner_info WHERE Email='$email'";
  ...
  if($res>0)
  {
    $message = '<div>
     ...
     <br>
     <p><button class="btn btn-primary"><a href="http://localhost/drbna1/Resert-passwordOwner.php?secret='.base64_encode($email).'">Reset Password</a></button></p>
     <br>
