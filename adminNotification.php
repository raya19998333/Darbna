...
<form class="d-flex" role="search">
    ...
    <h1 class="display-1" style="text-align: center;">List Of Notifications</h1>
    ...
    <div class="row"><div class="col-md-12">
            ...
            echo "<td><a class='btn btn-dark' href='adminUpdateNotify.php?notificationID={$row['notificationID']}&PassengerID={$row ['PassengerID']}&TripID={$row ['TripID']}&BookingID={$row ['BookingID']}'>Update</a></td>";
            



echo '<form action="adminDeleteNotification.php" method="POST">';
