...
<form class="d-flex" role="search">
    ...
    <h1 class="display-1" style="text-align: center;">List Of Private Owner</h1>
   ...
   include 'dbconnect.php';
    ...
    while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
      ...
      $i=$i+1;
      echo "<td><a class='btn btn-dark' href='adminUpdatePOwner.php?OwnerID={$row['OwnerID']}&Email={$row ['Email']}&Password={$row ['Password']}'>Update</a></td>";
            
      echo '<form action="adminDeleteOwaner.php" method="POST">';
      ...
      echo "</tbody>";
      echo "</table> ";
      echo "<h6 class='display-6' > The number of Owner Private :$i</h6>";
             ?>
