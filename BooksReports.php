...
<form class="d-flex" role="search">
    ...
    <h1 class="display-1" style="text-align: center;">Reports of books</h1>
    ...
    <?php
         ...
         $i=0;
           ...
           echo "<td><a class='btn btn-dark' href='adminUpdateBook.php?booking_id={$row['booking_id']}&passenger_id={$row ['passenger_id']}&Trip_id={$row ['Trip_id']}&email={$row ['email']}'>Update</a></td>";
            
           echo '<form action="adminDeleteBook.php" method="POST">';
