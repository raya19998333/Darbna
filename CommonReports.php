...
<form class="d-flex" role="search">
    ...
    <h1 class="display-1" style="text-align: center;">Reports Of  Common Trips</h1>
    ...
    <?php
         ...
         $i=0;
           ...
           echo "<td>{$row ['massage']}</td>";$i=$i+1;

           echo "<td><a class='btn btn-dark' href='adminUpdateCommon.php?trip_id={$row['trip_id']}&company_id={$row ['company_id']}'>Update</a></td>";
            


           echo '<form action="adminDeleteCommon.php" method="POST">';
          ...
          echo "</form>";}
           ...
           echo "  </tbody>";
           echo "</table> " ;
           echo "<h6 class='display-6' > The number of Trip of Companies :$i</h6>"; ?>  
