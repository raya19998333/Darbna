...
<form class="d-flex" role="search">
    ...
    <h1 class="display-1" style="text-align: center;">Reports Of Appoinment Passenger</h1>
    ...
    <table class="table table-striped">
        ...
        <?php
         ...
         $i=0;
           ...
           echo "<td><a class='btn btn-dark' href='adminUpdateAppointment.php?appointments_id={$row['appointments_id']}&passenger_id={$row ['passenger_id']}'>Update</a></td>";


           echo '<form action="adminDeleteAppoinment.php" method="POST">';
