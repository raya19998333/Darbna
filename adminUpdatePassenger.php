          ...
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <form class="mx-1 mx-md-4" method="POST" action="aaaUpdatePassenger.php"> 
                <div class="d-flex flex-row align-items-center mb-4">
                    <div class="form-outline flex-fill mb-0"><label for="text" class="">PassengerID</label>
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    <div class="form-outline flex-fill mb-0"><label for="text" class="">Email</label>
                      <input type="email" name="Email" value="<?php echo htmlspecialchars($_GET['Email'] ?? '', ENT_QUOTES); ?>" placeholder="Email" class="form-control" >
                    </div>
                  </div>
                 
                  <div class="d-flex flex-row align-items-center mb-4">
                    <div class="form-outline flex-fill mb-0"><label for="text" >Gender</label>
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    <div class="form-outline flex-fill mb-0"><label for="text" class="">Civil Number</label>
                      <input type="number"  class="form-control" name="CivilNo" >
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0"><label class="form-label" for="form3Example4c">Password</label>
                      <input type="password"  class="form-control" value="<?php echo htmlspecialchars($_GET['password_hash'] ?? '', ENT_QUOTES); ?>" name="password_hash"  />
